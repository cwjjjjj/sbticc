import type { DimensionMeta, DimensionLevel } from '../types'
...
export const dimensionOrder: string[] = [
  'S1', 'S2', 'S3', 'E1', 'E2', 'E3', 'A1', 'A2', 'A3', 'Ac1', 'Ac2', 'Ac3', 'So1', 'So2', 'So3',
]

export const DIM_EXPLANATIONS: Record<string, Record<DimensionLevel, string>> = {
  S1: {
