// Extracted verbatim from main.js (lines 1944-1988)

export interface CompatEntry { type: 'soulmate' | 'rival'; say: string }
...
export interface CompatResult { type: 'soulmate' | 'rival' | 'mirror' | 'normal'; say: string }
