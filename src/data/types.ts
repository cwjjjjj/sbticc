// Extracted verbatim from main.js (lines 330-493, 524-625, 1239-1267)

export interface TypeDef { code: string; cn: string; intro: string; desc: string }
export interface NormalType { code: string; pattern: string }
export interface RarityInfo { pct: number; stars: number; label: string }
