// Extracted verbatim from main.js (lines 16-32, 626-703)

export interface DimensionInfo { name: string; model: string }
...
export const dimensionOrder: string[] = ['S1', 'S2', 'S3', 'E1', 'E2', 'E3', 'A1', 'A2', 'A3', 'Ac1', 'Ac2', 'Ac3', 'So1', 'So2', 'So3'];

export interface DimExplanation { L: string; M: string; H: string }

export const DIM_EXPLANATIONS: Record<string, DimExplanation> = {
    "S1": {
